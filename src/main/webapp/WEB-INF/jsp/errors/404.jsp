...
<head>
    <meta charset="UTF-8">
    <title>404 Not Found - RandomPost</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link href="${pageContext.request.contextPath}/css/bootstrap.min.css" rel="stylesheet">

    <%-- Única librería de íconos necesaria (Para Navbar y Error) --%>
    <link href="${pageContext.request.contextPath}/css/bootstrap-icons.css" rel="stylesheet">

    <%-- CSS Autónomo para páginas de error --%>
...
<main class="flex-grow-1">
    <div class="container error-page-container">
        ...
        <div class="error-icon text-primary opacity-75">
